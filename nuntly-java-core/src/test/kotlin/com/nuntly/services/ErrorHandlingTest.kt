...
import com.nuntly.errors.NuntlyException
...
internal class ErrorHandlingTest {
    ...
    @Test
    fun apiKeysCreate400WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
                    status(400).withHeader(HEADER_NAME, HEADER_VALUE).withBody(ERROR_JSON_BYTES)
    ...
    @Test
    fun apiKeysCreate401WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
    ...
    @Test
    fun apiKeysCreate403WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
    ...
    @Test
    fun apiKeysCreate404WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
    ...
    @Test
    fun apiKeysCreate422WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
    ...
    @Test
    fun apiKeysCreate429WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
    ...
    @Test
    fun apiKeysCreate500WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
    ...
    @Test
    fun apiKeysCreate999WithRawResponse() {
        val apiKeyService = client.apiKeys().withRawResponse()
        stubFor(
            post(anyUrl())
                .willReturn(
    ...
    @Test
    fun apiKeysCreateInvalidJsonBody() {
        val apiKeyService = client.apiKeys()
        stubFor(
            post(anyUrl())
