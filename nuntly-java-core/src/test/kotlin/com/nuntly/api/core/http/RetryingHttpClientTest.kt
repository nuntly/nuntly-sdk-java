...
import com.nuntly.api.client.okhttp.OkHttpClient
import com.nuntly.api.core.RequestOptions
import com.nuntly.api.errors.NuntlyRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw NuntlyRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            NuntlyRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
