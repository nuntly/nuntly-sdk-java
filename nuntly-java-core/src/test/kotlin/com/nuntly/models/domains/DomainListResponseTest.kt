    ...
    fun create() {
        val domainListResponse =
            DomainListResponse.builder()
                ...
                .createdAt("createdAt")
                .name("name")
                .receivingStatus(DomainListResponse.ReceivingStatus.DISABLED)
        ...
        assertThat(domainListResponse.receivingStatus())
            .isEqualTo(DomainListResponse.ReceivingStatus.DISABLED)
