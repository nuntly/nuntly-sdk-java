    ...
    fun create() {
        val domainCreateResponse =
            DomainCreateResponse.builder()
                ...
                .openTracking(true)
                .receiving(true)
                .receivingStatus(DomainCreateResponse.ReceivingStatus.DISABLED)
                .receivingStatusAt("receivingStatusAt")
                .addRecord(
                    DomainCreateResponse.Record.builder()
                        .fullname("fullname")
                        .group(DomainCreateResponse.Record.Group.DKIM)
                        .name("name")
                        .recordType(DomainCreateResponse.Record.RecordType.TXT)
                        .status(DomainCreateResponse.Record.Status.BOOTSTRAPPING)
                        .statusAt("statusAt")
                        .ttl("ttl")
                        .value("value")
                        .priority("priority")
        ...
        assertThat(domainCreateResponse.receiving()).isEqualTo(true)
        assertThat(domainCreateResponse.receivingStatus())
            .isEqualTo(DomainCreateResponse.ReceivingStatus.DISABLED)
        assertThat(domainCreateResponse.receivingStatusAt()).isEqualTo("receivingStatusAt")
        assertThat(domainCreateResponse.records())
            .containsExactly(
                DomainCreateResponse.Record.builder()
                    .fullname("fullname")
                    .group(DomainCreateResponse.Record.Group.DKIM)
        ...
        assertThat(domainCreateResponse.sending()).isEqualTo(true)
        assertThat(domainCreateResponse.sendingStatus())
            .isEqualTo(DomainCreateResponse.SendingStatus.ENABLED)
        assertThat(domainCreateResponse.sendingStatusAt()).isEqualTo("sendingStatusAt")
