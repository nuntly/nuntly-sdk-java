...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.nuntly.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.nuntly.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.nuntly.** {
    <init>(...);
