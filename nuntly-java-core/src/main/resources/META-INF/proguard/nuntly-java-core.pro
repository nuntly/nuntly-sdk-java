...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.nuntly.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.nuntly.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.nuntly.api.** {
    <init>(...);
