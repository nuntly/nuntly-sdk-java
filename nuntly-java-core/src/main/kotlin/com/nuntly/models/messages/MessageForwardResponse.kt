...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageForwardResponse].
         *
    ...
    /** A builder for [MessageForwardResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageForwardResponse: MessageForwardResponse) = apply {
            id = messageForwardResponse.id
            messageId = messageForwardResponse.messageId
            subject = messageForwardResponse.subject
            threadId = messageForwardResponse.threadId
            additionalProperties = messageForwardResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageForwardResponse].
         *
         ...
         */
        fun build(): MessageForwardResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageForwardResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "MessageForwardResponse{id=$id, messageId=$messageId, subject=$subject, threadId=$threadId, additionalProperties=$additionalProperties}"
}
