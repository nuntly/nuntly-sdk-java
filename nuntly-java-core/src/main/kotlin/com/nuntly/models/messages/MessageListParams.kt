...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageListParams: MessageListParams) = apply {
            ...
            domainId = messageListParams.domainId
            from = messageListParams.from
    ...
    override fun hashCode(): Int =
        Objects.hash(cursor, domainId, from, limit, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "MessageListParams{cursor=$cursor, domainId=$domainId, from=$from, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
