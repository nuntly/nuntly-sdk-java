...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AttachmentListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(attachmentListParams: AttachmentListParams) = apply {
            messageId = attachmentListParams.messageId
    ...
    override fun toString() =
        "AttachmentListParams{messageId=$messageId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
