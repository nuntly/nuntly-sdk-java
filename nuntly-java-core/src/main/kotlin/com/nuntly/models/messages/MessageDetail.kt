...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageDetail].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageDetail: MessageDetail) = apply {
            id = messageDetail.id
            attachmentCount = messageDetail.attachmentCount
            bcc = messageDetail.bcc.map { it.toMutableList() }
            cc = messageDetail.cc.map { it.toMutableList() }
            ...
            to = messageDetail.to.map { it.toMutableList() }
            additionalProperties = messageDetail.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageDetail].
         *
