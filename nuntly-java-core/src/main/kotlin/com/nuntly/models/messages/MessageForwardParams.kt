...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageForwardParams].
         *
    ...
    /** A builder for [MessageForwardParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageForwardParams: MessageForwardParams) = apply {
            messageId = messageForwardParams.messageId
            body = messageForwardParams.body.toBuilder()
            additionalHeaders = messageForwardParams.additionalHeaders.toBuilder()
            additionalQueryParams = messageForwardParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MessageForwardParams].
         *
         ...
         */
        fun build(): MessageForwardParams =
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (to.asKnown().getOrNull()?.size ?: 0) + (if (text.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(to, text, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{to=$to, text=$text, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageForwardParams &&
    ...
    override fun toString() =
        "MessageForwardParams{messageId=$messageId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
