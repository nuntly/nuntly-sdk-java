...
private constructor(
    private val data: JsonField<List<MessageListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<MessageListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<MessageListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<MessageListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<MessageListResponse>>? = null
        ...
        internal fun from(messageListPageResponse: MessageListPageResponse) = apply {
            ...
            nextCursor = messageListPageResponse.nextCursor
            additionalProperties = messageListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<MessageListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<MessageListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<MessageListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [MessageListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: MessageListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "MessageListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
