...
private constructor(
    ...
    ) : this(id, createdAt, externalId, name, updatedAt, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [Namespace].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(namespace: Namespace) = apply {
            id = namespace.id
            createdAt = namespace.createdAt
            externalId = namespace.externalId
            name = namespace.name
            updatedAt = namespace.updatedAt
            additionalProperties = namespace.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [Namespace].
         *
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, externalId, name, updatedAt, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "Namespace{id=$id, createdAt=$createdAt, externalId=$externalId, name=$name, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
