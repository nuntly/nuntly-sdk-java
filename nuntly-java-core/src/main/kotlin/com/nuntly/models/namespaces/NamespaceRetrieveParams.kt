...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): NamespaceRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(namespaceRetrieveParams: NamespaceRetrieveParams) = apply {
            namespaceId = namespaceRetrieveParams.namespaceId
    ...
    override fun hashCode(): Int =
        Objects.hash(namespaceId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "NamespaceRetrieveParams{namespaceId=$namespaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
