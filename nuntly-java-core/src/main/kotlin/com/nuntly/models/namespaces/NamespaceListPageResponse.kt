...
private constructor(
    private val data: JsonField<List<Namespace>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Namespace>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Namespace> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Namespace>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Namespace>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(namespaceListPageResponse: NamespaceListPageResponse) = apply {
            data = namespaceListPageResponse.data.map { it.toMutableList() }
        ...
        fun data(data: List<Namespace>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<Namespace>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Namespace>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Namespace] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Namespace) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NamespaceListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "NamespaceListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
