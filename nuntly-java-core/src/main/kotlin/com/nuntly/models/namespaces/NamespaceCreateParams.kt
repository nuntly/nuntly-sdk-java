...
private constructor(
    ...
    private constructor(
        ...
        ) : this(name, externalId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("name", name), externalId, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy { Objects.hash(name, externalId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, externalId=$externalId, additionalProperties=$additionalProperties}"
    }
