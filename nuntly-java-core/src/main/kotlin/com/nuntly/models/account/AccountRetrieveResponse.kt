...
package com.nuntly.models.account
...
private constructor(
    ...
    ) : this(id, createdAt, displayName, email, kind, region, modifiedAt, picture, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountRetrieveResponse: AccountRetrieveResponse) = apply {
            ...
            displayName = accountRetrieveResponse.displayName
            email = accountRetrieveResponse.email
            kind = accountRetrieveResponse.kind
            region = accountRetrieveResponse.region
            modifiedAt = accountRetrieveResponse.modifiedAt
            picture = accountRetrieveResponse.picture
        ...
        /** The profile picture of the user */
        fun picture(picture: String) = picture(JsonField.of(picture))
    ...
    override fun toString() =
        "AccountRetrieveResponse{id=$id, createdAt=$createdAt, displayName=$displayName, email=$email, kind=$kind, region=$region, modifiedAt=$modifiedAt, picture=$picture, additionalProperties=$additionalProperties}"
}
