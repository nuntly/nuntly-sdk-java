...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyRetrieveResponse: ApiKeyRetrieveResponse) = apply {
            ...
            shortToken = apiKeyRetrieveResponse.shortToken
    ...
    override fun toString() =
        "ApiKeyRetrieveResponse{id=$id, createdAt=$createdAt, shortToken=$shortToken, status=$status, name=$name, additionalProperties=$additionalProperties}"
}
