...
private constructor(
    private val data: JsonField<List<ApiKeyListResponse>>,
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ApiKeyListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ApiKeyListResponse>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(apiKeyListPageResponse: ApiKeyListPageResponse) = apply {
            data = apiKeyListPageResponse.data.map { it.toMutableList() }
            nextCursor = apiKeyListPageResponse.nextCursor
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<ApiKeyListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ApiKeyListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ApiKeyListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ApiKeyListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "ApiKeyListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
