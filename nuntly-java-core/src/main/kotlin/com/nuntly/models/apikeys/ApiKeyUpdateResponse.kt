...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyUpdateResponse: ApiKeyUpdateResponse) = apply {
            ...
            kind = apiKeyUpdateResponse.kind
            orgId = apiKeyUpdateResponse.orgId
    ...
    override fun toString() =
        "ApiKeyUpdateResponse{id=$id, kind=$kind, orgId=$orgId, additionalProperties=$additionalProperties}"
}
