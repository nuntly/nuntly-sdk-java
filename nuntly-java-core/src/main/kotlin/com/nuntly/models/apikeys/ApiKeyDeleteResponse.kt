...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyDeleteResponse: ApiKeyDeleteResponse) = apply {
            id = apiKeyDeleteResponse.id
            kind = apiKeyDeleteResponse.kind
            orgId = apiKeyDeleteResponse.orgId
    ...
    override fun toString() =
        "ApiKeyDeleteResponse{id=$id, kind=$kind, orgId=$orgId, additionalProperties=$additionalProperties}"
}
