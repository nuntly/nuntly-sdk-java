...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyCreateResponse: ApiKeyCreateResponse) = apply {
            ...
            apikeyTruncated = apiKeyCreateResponse.apikeyTruncated
            createdAt = apiKeyCreateResponse.createdAt
            kind = apiKeyCreateResponse.kind
            orgId = apiKeyCreateResponse.orgId
            region = apiKeyCreateResponse.region
            status = apiKeyCreateResponse.status
            userId = apiKeyCreateResponse.userId
            modifiedAt = apiKeyCreateResponse.modifiedAt
    ...
    override fun toString() =
        "ApiKeyCreateResponse{id=$id, apikey=$apikey, apikeyTruncated=$apikeyTruncated, createdAt=$createdAt, kind=$kind, orgId=$orgId, region=$region, status=$status, userId=$userId, modifiedAt=$modifiedAt, name=$name, additionalProperties=$additionalProperties}"
}
