...
private constructor(
    ...
    ) : this(id, apiKey, shortToken, status, name, mutableMapOf())
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyCreateResponse: ApiKeyCreateResponse) = apply {
            ...
            shortToken = apiKeyCreateResponse.shortToken
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, apiKey, shortToken, status, name, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "ApiKeyCreateResponse{id=$id, apiKey=$apiKey, shortToken=$shortToken, status=$status, name=$name, additionalProperties=$additionalProperties}"
}
