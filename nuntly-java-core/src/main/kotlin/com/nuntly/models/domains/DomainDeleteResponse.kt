...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DomainDeleteResponse].
         *
    ...
    /** A builder for [DomainDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(domainDeleteResponse: DomainDeleteResponse) = apply {
            id = domainDeleteResponse.id
            kind = domainDeleteResponse.kind
            orgId = domainDeleteResponse.orgId
            additionalProperties = domainDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DomainDeleteResponse].
         *
         ...
         */
        fun build(): DomainDeleteResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DomainDeleteResponse &&
            id == other.id &&
            kind == other.kind &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "DomainDeleteResponse{id=$id, kind=$kind, orgId=$orgId, additionalProperties=$additionalProperties}"
}
