...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DomainRetrieveResponse].
         *
    ...
    /** A builder for [DomainRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(domainRetrieveResponse: DomainRetrieveResponse) = apply {
            id = domainRetrieveResponse.id
            clickTracking = domainRetrieveResponse.clickTracking
            createdAt = domainRetrieveResponse.createdAt
            kind = domainRetrieveResponse.kind
            name = domainRetrieveResponse.name
            openTracking = domainRetrieveResponse.openTracking
            orgId = domainRetrieveResponse.orgId
            ...
            modifiedAt = domainRetrieveResponse.modifiedAt
        ...
        /**
         * Returns an immutable instance of [DomainRetrieveResponse].
         *
         ...
         */
        fun build(): DomainRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DomainRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "DomainRetrieveResponse{id=$id, clickTracking=$clickTracking, createdAt=$createdAt, kind=$kind, name=$name, openTracking=$openTracking, orgId=$orgId, region=$region, sendingRecords=$sendingRecords, sendingStatus=$sendingStatus, status=$status, statusAt=$statusAt, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
}
