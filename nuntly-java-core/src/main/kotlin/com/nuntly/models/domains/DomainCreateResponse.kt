...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(domainCreateResponse: DomainCreateResponse) = apply {
            ...
            receiving = domainCreateResponse.receiving
            receivingStatus = domainCreateResponse.receivingStatus
            receivingStatusAt = domainCreateResponse.receivingStatusAt
            records = domainCreateResponse.records.map { it.toMutableList() }
            region = domainCreateResponse.region
            sending = domainCreateResponse.sending
            sendingStatus = domainCreateResponse.sendingStatus
            sendingStatusAt = domainCreateResponse.sendingStatusAt
