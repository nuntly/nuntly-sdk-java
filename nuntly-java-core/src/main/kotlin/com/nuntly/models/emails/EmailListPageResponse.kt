...
private constructor(
    private val data: JsonField<List<EmailListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EmailListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<EmailListResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EmailListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<EmailListResponse>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(emailListPageResponse: EmailListPageResponse) = apply {
            data = emailListPageResponse.data.map { it.toMutableList() }
            nextCursor = emailListPageResponse.nextCursor
            additionalProperties = emailListPageResponse.additionalProperties.toMutableMap()
        }

        /** The emails */
        fun data(data: List<EmailListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EmailListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<EmailListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EmailListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EmailListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "EmailListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
