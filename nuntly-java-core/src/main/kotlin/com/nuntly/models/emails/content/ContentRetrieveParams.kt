...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ContentRetrieveParams =
            ContentRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ContentRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
