...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BulkRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BulkRetrieveParams]. */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [BulkRetrieveParams].
         *
