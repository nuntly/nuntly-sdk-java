...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailContentItem].
         *
    ...
    /** A builder for [EmailContentItem]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailContentItem: EmailContentItem) = apply {
            downloadUrl = emailContentItem.downloadUrl
            expiresAt = emailContentItem.expiresAt
            size = emailContentItem.size
            additionalProperties = emailContentItem.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailContentItem].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailContentItem &&
    ...
    override fun toString() =
        "EmailContentItem{downloadUrl=$downloadUrl, expiresAt=$expiresAt, size=$size, additionalProperties=$additionalProperties}"
}
