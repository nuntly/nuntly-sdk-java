...
private constructor(
    ...
    ) : this(id, kind, orgId, status, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailSendResponse].
         *
    ...
    /** A builder for [EmailSendResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailSendResponse: EmailSendResponse) = apply {
            id = emailSendResponse.id
            kind = emailSendResponse.kind
            orgId = emailSendResponse.orgId
            status = emailSendResponse.status
            additionalProperties = emailSendResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailSendResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailSendResponse &&
            id == other.id &&
            kind == other.kind &&
            orgId == other.orgId &&
            status == other.status &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, kind, orgId, status, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "EmailSendResponse{id=$id, kind=$kind, orgId=$orgId, status=$status, additionalProperties=$additionalProperties}"
}
