...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): EmailListParams =
            EmailListParams(cursor, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "EmailListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
