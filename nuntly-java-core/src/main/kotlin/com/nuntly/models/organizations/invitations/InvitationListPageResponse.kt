...
private constructor(
    private val data: JsonField<List<InvitationListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<InvitationListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<InvitationListResponse>> = data.getOptional("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<InvitationListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<InvitationListResponse>>? = null
        private var nextCursor: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(invitationListPageResponse: InvitationListPageResponse) = apply {
            data = invitationListPageResponse.data.map { it.toMutableList() }
            nextCursor = invitationListPageResponse.nextCursor
            additionalProperties = invitationListPageResponse.additionalProperties.toMutableMap()
        }

        /** The invitations of this organization */
        fun data(data: List<InvitationListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<InvitationListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<InvitationListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [InvitationListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: InvitationListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "InvitationListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
