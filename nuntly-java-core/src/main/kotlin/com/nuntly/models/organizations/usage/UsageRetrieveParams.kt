...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): UsageRetrieveParams =
            UsageRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "UsageRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
