...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationUpdateResponse: OrganizationUpdateResponse) = apply {
            id = organizationUpdateResponse.id
            kind = organizationUpdateResponse.kind
    ...
    override fun toString() =
        "OrganizationUpdateResponse{id=$id, kind=$kind, additionalProperties=$additionalProperties}"
}
