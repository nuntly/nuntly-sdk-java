...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationRetrieveParams: OrganizationRetrieveParams) = apply {
            id = organizationRetrieveParams.id
            additionalHeaders = organizationRetrieveParams.additionalHeaders.toBuilder()
        ...
        fun build(): OrganizationRetrieveParams =
            OrganizationRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "OrganizationRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
