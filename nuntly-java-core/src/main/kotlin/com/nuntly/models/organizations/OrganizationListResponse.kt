...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationListResponse: OrganizationListResponse) = apply {
            ...
            displayName = organizationListResponse.displayName
            kind = organizationListResponse.kind
            orgId = organizationListResponse.orgId
            region = organizationListResponse.region
            status = organizationListResponse.status
            modifiedAt = organizationListResponse.modifiedAt
    ...
    override fun toString() =
        "OrganizationListResponse{createdAt=$createdAt, displayName=$displayName, kind=$kind, orgId=$orgId, region=$region, status=$status, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
}
