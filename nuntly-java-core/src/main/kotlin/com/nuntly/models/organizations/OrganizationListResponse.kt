...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationListResponse: OrganizationListResponse) = apply {
            id = organizationListResponse.id
            name = organizationListResponse.name
    ...
    override fun toString() =
        "OrganizationListResponse{id=$id, name=$name, status=$status, additionalProperties=$additionalProperties}"
}
