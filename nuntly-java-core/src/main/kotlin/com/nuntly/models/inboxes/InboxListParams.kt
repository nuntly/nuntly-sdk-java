...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inboxListParams: InboxListParams) = apply {
            cursor = inboxListParams.cursor
            limit = inboxListParams.limit
            namespaceId = inboxListParams.namespaceId
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                namespaceId?.let { put("namespaceId", it) }
    ...
    override fun hashCode(): Int =
        Objects.hash(cursor, limit, namespaceId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "InboxListParams{cursor=$cursor, limit=$limit, namespaceId=$namespaceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
