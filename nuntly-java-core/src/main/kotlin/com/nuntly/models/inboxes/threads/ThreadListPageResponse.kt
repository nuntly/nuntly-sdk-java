...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(threadListPageResponse: ThreadListPageResponse) = apply {
            data = threadListPageResponse.data.map { it.toMutableList() }
            nextCursor = threadListPageResponse.nextCursor
            additionalProperties = threadListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): ThreadListPageResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ThreadListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ThreadListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
