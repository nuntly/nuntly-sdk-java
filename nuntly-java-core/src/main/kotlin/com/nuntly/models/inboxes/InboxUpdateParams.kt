...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InboxUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [InboxUpdateParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InboxUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inboxUpdateParams: InboxUpdateParams) = apply {
            inboxId = inboxUpdateParams.inboxId
            body = inboxUpdateParams.body.toBuilder()
            additionalHeaders = inboxUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = inboxUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [InboxUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InboxUpdateParams =
            InboxUpdateParams(
                inboxId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InboxUpdateParams &&
    ...
    override fun toString() =
        "InboxUpdateParams{inboxId=$inboxId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
