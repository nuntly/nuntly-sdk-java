...
class EmailStatus @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        @JvmStatic fun of(value: String) = EmailStatus(JsonField.of(value))
    }

    /** An enum containing [EmailStatus]'s known values. */
    enum class Known {
        QUEUED,
        SCHEDULED,
        PROCESSED,
    ...
    /**
     * An enum containing [EmailStatus]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [EmailStatus] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        CANCELED,
        REJECTED,
        /** An enum member indicating that [EmailStatus] was instantiated with an unknown value. */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            else -> throw NuntlyInvalidDataException("Unknown EmailStatus: $value")
        }
    ...
    fun validate(): EmailStatus = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailStatus && value == other.value
    }
