...
private constructor(
    ...
    ) : this(id, createdAt, endpointUrl, events, signingSecret, status, name, mutableMapOf())
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun signingSecret(): String = signingSecret.getRequired("signingSecret")
    ...
    override fun toString() =
        "WebhookCreateResponse{id=$id, createdAt=$createdAt, endpointUrl=$endpointUrl, events=$events, signingSecret=$signingSecret, status=$status, name=$name, additionalProperties=$additionalProperties}"
}
