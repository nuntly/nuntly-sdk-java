...
private constructor(
    ...
    private constructor(
        ...
        private val reject: JsonField<RejectDetail>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @JsonProperty("reject")
            @ExcludeMissing
            reject: JsonField<RejectDetail> = JsonMissing.of(),
        ) : this(
            id,
            domain,
            domainId,
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun reject(): RejectDetail = reject.getRequired("reject")
         ...
         */
        @JsonProperty("reject") @ExcludeMissing fun _reject(): JsonField<RejectDetail> = reject
        ...
        class Builder internal constructor() {
            ...
            private var reject: JsonField<RejectDetail>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            fun reject(reject: RejectDetail) = reject(JsonField.of(reject))

            /**
             * Sets [Builder.reject] to an arbitrary JSON value.
             *
             * You should usually call [Builder.reject] with a well-typed [RejectDetail] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun reject(reject: JsonField<RejectDetail>) = apply { this.reject = reject }
        ...
        override fun toString() =
            "Data{id=$id, domain=$domain, domainId=$domainId, enqueueAt=$enqueueAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, reject=$reject, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EmailRejectedEvent{id=$id, createdAt=$createdAt, type=$type, kind=$kind, data=$data, additionalProperties=$additionalProperties}"
}
