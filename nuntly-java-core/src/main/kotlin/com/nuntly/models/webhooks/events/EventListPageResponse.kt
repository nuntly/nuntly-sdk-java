...
private constructor(
     ...
     */
    fun data(): List<EventListResponse> = data.getRequired("data")
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventListPageResponse: EventListPageResponse) = apply {
            ...
            nextCursor = eventListPageResponse.nextCursor
    ...
    override fun toString() =
        "EventListPageResponse{data=$data, nextCursor=$nextCursor, additionalProperties=$additionalProperties}"
}
