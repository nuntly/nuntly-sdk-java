...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailOpenedEvent].
         *
    ...
    /** A builder for [EmailOpenedEvent]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [EmailOpenedEvent].
         *
    ...
    fun validate(): EmailOpenedEvent = apply {
        if (validated) {
            return@apply
        }
