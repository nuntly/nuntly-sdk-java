...
private constructor(
     ...
     *     @Override
     *     public Optional<String> visitEmailQueued(EmailQueuedEvent emailQueued) {
     *         return Optional.of(emailQueued.toString());
     *     }
     *
     *     // ...
     *
     ...
     * ```
     *
     * @throws NuntlyInvalidDataException if [Visitor.unknown] is not overridden in [visitor] and
