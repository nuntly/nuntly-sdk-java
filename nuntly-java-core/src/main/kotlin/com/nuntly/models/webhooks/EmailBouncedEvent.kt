...
private constructor(
    ...
    private constructor(
        private val id: JsonField<String>,
        private val bounce: JsonField<Bounce>,
        ...
        private constructor(
            @JsonProperty("id") @ExcludeMissing id: JsonField<String> = JsonMissing.of(),
            @JsonProperty("bounce") @ExcludeMissing bounce: JsonField<Bounce> = JsonMissing.of(),
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun bounce(): Bounce = bounce.getRequired("bounce")
         ...
         */
        @JsonProperty("bounce") @ExcludeMissing fun _bounce(): JsonField<Bounce> = bounce
        ...
        class Builder internal constructor() {
            ...
            private var id: JsonField<String>? = null
            private var bounce: JsonField<Bounce>? = null
            ...
            fun bounce(bounce: Bounce) = bounce(JsonField.of(bounce))

            /**
             * Sets [Builder.bounce] to an arbitrary JSON value.
             *
             * You should usually call [Builder.bounce] with a well-typed [Bounce] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun bounce(bounce: JsonField<Bounce>) = apply { this.bounce = bounce }
        ...
        private constructor(
            ...
            private val bounceSubType: JsonField<BounceSubType>,
            private val bounceType: JsonField<BounceType>,
             ...
             *   value).
             */
            fun bouncedAt(): String = bouncedAt.getRequired("bouncedAt")
            ...
            fun bouncedRecipients(): List<BouncedRecipient> =
                bouncedRecipients.getRequired("bouncedRecipients")
             ...
             *   value).
             */
            fun bounceSubType(): BounceSubType = bounceSubType.getRequired("bounceSubType")
             ...
             *   value).
             */
            fun bounceType(): BounceType = bounceType.getRequired("bounceType")
             ...
             */
            fun reportingMta(): Optional<String> = reportingMta.getOptional("reportingMta")

            /**
             * Returns the raw JSON value of [bouncedAt].
             *
             * Unlike [bouncedAt], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("bouncedAt")
            @ExcludeMissing
            fun _bouncedAt(): JsonField<String> = bouncedAt

            /**
             * Returns the raw JSON value of [bouncedRecipients].
             *
             * Unlike [bouncedRecipients], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("bouncedRecipients")
            @ExcludeMissing
             ...
             *
             * Unlike [bounceSubType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("bounceSubType")
            @ExcludeMissing
            fun _bounceSubType(): JsonField<BounceSubType> = bounceSubType

            /**
             * Returns the raw JSON value of [bounceType].
             *
             * Unlike [bounceType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("bounceType")
            @ExcludeMissing
            fun _bounceType(): JsonField<BounceType> = bounceType
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [Bounce].
                 *
                 * The following fields are required:
                 * ```java
                 * .bouncedAt()
            ...
            class Builder internal constructor() {
                ...
                private var bounceSubType: JsonField<BounceSubType>? = null
                private var bounceType: JsonField<BounceType>? = null
                private var feedbackId: JsonField<String>? = null
                private var reportingMta: JsonField<String> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                @JvmSynthetic
                internal fun from(bounce: Bounce) = apply {
                    bouncedAt = bounce.bouncedAt
                    bouncedRecipients = bounce.bouncedRecipients.map { it.toMutableList() }
                    bounceSubType = bounce.bounceSubType
                    bounceType = bounce.bounceType
                    feedbackId = bounce.feedbackId
                    reportingMta = bounce.reportingMta
                    additionalProperties = bounce.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.bouncedAt] with a well-typed [String] value
                 ...
                 * `List<BouncedRecipient>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                fun bouncedRecipients(bouncedRecipients: JsonField<List<BouncedRecipient>>) =
                    apply {
                ...
                fun bounceSubType(bounceSubType: BounceSubType) =
                    bounceSubType(JsonField.of(bounceSubType))

                /**
                 * Sets [Builder.bounceSubType] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.bounceSubType] with a well-typed [BounceSubType]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun bounceSubType(bounceSubType: JsonField<BounceSubType>) = apply {
                    this.bounceSubType = bounceSubType
                }

                fun bounceType(bounceType: BounceType) = bounceType(JsonField.of(bounceType))

                /**
                 * Sets [Builder.bounceType] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.bounceType] with a well-typed [BounceType] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun bounceType(bounceType: JsonField<BounceType>) = apply {
                ...
                /**
                 * Returns an immutable instance of [Bounce].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                ...
                fun build(): Bounce =
                    Bounce(
                        ...
                        checkRequired("bouncedRecipients", bouncedRecipients).map {
                            it.toImmutable()
                        },
            ...
            internal fun validity(): Int =
                (if (bouncedAt.asKnown().isPresent) 1 else 0) +
                    (bouncedRecipients.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                        ?: 0) +
                    (bounceSubType.asKnown().getOrNull()?.validity() ?: 0) +
                    (bounceType.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val NO_EMAIL = of("NoEmail")
                    ...
                    @JvmField val MESSAGE_TOO_LARGE = of("MessageTooLarge")

                    @JvmField val CUSTOM_TIMEOUT_EXCEEDED = of("CustomTimeoutExceeded")

                    @JvmField val CONTENT_REJECTED = of("ContentRejected")

                    @JvmField val ATTACHMENT_REJECTED = of("AttachmentRejected")

                    @JvmStatic fun of(value: String) = BounceSubType(JsonField.of(value))
                }

                /** An enum containing [BounceSubType]'s known values. */
                enum class Known {
                    UNDETERMINED,
                    GENERAL,
                    NO_EMAIL,
                    ...
                    MAILBOX_FULL,
                    MESSAGE_TOO_LARGE,
                    CUSTOM_TIMEOUT_EXCEEDED,
                    CONTENT_REJECTED,
                    ATTACHMENT_REJECTED,
                }

                /**
                 * An enum containing [BounceSubType]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [BounceSubType] can contain an unknown value in a couple of cases:
                ...
                enum class Value {
                    ...
                    ATTACHMENT_REJECTED,
                    /**
                     * An enum member indicating that [BounceSubType] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
                ...
                fun value(): Value =
                    when (this) {
                        ...
                        CUSTOM_TIMEOUT_EXCEEDED -> Value.CUSTOM_TIMEOUT_EXCEEDED
                        CONTENT_REJECTED -> Value.CONTENT_REJECTED
                        ATTACHMENT_REJECTED -> Value.ATTACHMENT_REJECTED
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        CUSTOM_TIMEOUT_EXCEEDED -> Known.CUSTOM_TIMEOUT_EXCEEDED
                        CONTENT_REJECTED -> Known.CONTENT_REJECTED
                        ATTACHMENT_REJECTED -> Known.ATTACHMENT_REJECTED
                        else -> throw NuntlyInvalidDataException("Unknown BounceSubType: $value")
                    }
                 ...
                 *   its expected type.
                 */
                fun validate(): BounceSubType = apply {
                    if (validated) {
                        return@apply
                    }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is BounceSubType && value == other.value
                }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                companion object {
                    ...
                    @JvmField val PERMANENT = of("Permanent")

                    @JvmField val UNDETERMINED = of("Undetermined")

                    @JvmField val TRANSIENT = of("Transient")

                    @JvmStatic fun of(value: String) = BounceType(JsonField.of(value))
                }

                /** An enum containing [BounceType]'s known values. */
                enum class Known {
                    PERMANENT,
                    UNDETERMINED,
                    TRANSIENT,
                ...
                /**
                 * An enum containing [BounceType]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [BounceType] can contain an unknown value in a couple of cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
                 * - It was constructed with an arbitrary value using the [of] method.
                ...
                enum class Value {
                    ...
                    TRANSIENT,
                    /**
                     * An enum member indicating that [BounceType] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        else -> throw NuntlyInvalidDataException("Unknown BounceType: $value")
                    }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is BounceType && value == other.value
                }
            ...
            override fun toString() =
                "Bounce{bouncedAt=$bouncedAt, bouncedRecipients=$bouncedRecipients, bounceSubType=$bounceSubType, bounceType=$bounceType, feedbackId=$feedbackId, reportingMta=$reportingMta, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "Data{id=$id, bounce=$bounce, domainId=$domainId, domainName=$domainName, enqueuedAt=$enqueuedAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EmailBouncedEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
