...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageSentEvent].
         *
    ...
    /** A builder for [MessageSentEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageSentEvent: MessageSentEvent) = apply {
            id = messageSentEvent.id
            createdAt = messageSentEvent.createdAt
            data = messageSentEvent.data
            type = messageSentEvent.type
            additionalProperties = messageSentEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageSentEvent].
         *
    ...
    fun validate(): MessageSentEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageSentEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "MessageSentEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
