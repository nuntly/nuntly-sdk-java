...
private constructor(
    ...
    private constructor(
        ...
        private val failure: JsonField<FailureDetail>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            failure: JsonField<FailureDetail> = JsonMissing.of(),
        ) : this(
            id,
            domain,
            domainId,
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun failure(): FailureDetail = failure.getRequired("failure")
         ...
         */
        @JsonProperty("failure") @ExcludeMissing fun _failure(): JsonField<FailureDetail> = failure
        ...
        class Builder internal constructor() {
            ...
            private var failure: JsonField<FailureDetail>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            fun failure(failure: FailureDetail) = failure(JsonField.of(failure))

            /**
             * Sets [Builder.failure] to an arbitrary JSON value.
             *
             * You should usually call [Builder.failure] with a well-typed [FailureDetail] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun failure(failure: JsonField<FailureDetail>) = apply { this.failure = failure }
        ...
        override fun toString() =
            "Data{id=$id, domain=$domain, domainId=$domainId, enqueueAt=$enqueueAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, failure=$failure, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EmailFailedEvent{id=$id, createdAt=$createdAt, type=$type, kind=$kind, data=$data, additionalProperties=$additionalProperties}"
}
