...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailFailedEvent].
         *
    ...
    /** A builder for [EmailFailedEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var createdAt: JsonField<String>? = null
        private var data: JsonField<Data>? = null
        private var type: JsonValue = JsonValue.from("email.failed")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(emailFailedEvent: EmailFailedEvent) = apply {
            id = emailFailedEvent.id
            createdAt = emailFailedEvent.createdAt
            data = emailFailedEvent.data
            type = emailFailedEvent.type
            additionalProperties = emailFailedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailFailedEvent].
         *
    ...
    fun validate(): EmailFailedEvent = apply {
        if (validated) {
            return@apply
        }
        ...
        data().validate()
        _type().let {
            if (it != JsonValue.from("email.failed")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            type.let { if (it == JsonValue.from("email.failed")) 1 else 0 }
    ...
    private constructor(
        ...
        private val failure: JsonField<Failure>,
        ...
        private constructor(
            ...
            @JsonProperty("failure") @ExcludeMissing failure: JsonField<Failure> = JsonMissing.of(),
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun failure(): Failure = failure.getRequired("failure")
         ...
         */
        @JsonProperty("failure") @ExcludeMissing fun _failure(): JsonField<Failure> = failure
        ...
        class Builder internal constructor() {
            ...
            private var failure: JsonField<Failure>? = null
            ...
            fun failure(failure: Failure) = failure(JsonField.of(failure))

            /**
             * Sets [Builder.failure] to an arbitrary JSON value.
             *
             * You should usually call [Builder.failure] with a well-typed [Failure] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun failure(failure: JsonField<Failure>) = apply { this.failure = failure }
        ...
        private constructor(
             ...
             * method:
             * ```java
             * MyClass myObject = failure.error().convert(MyClass.class);
             * ```
             */
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [Failure].
                 *
                 * The following fields are required:
                 * ```java
                 * .error()
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(failure: Failure) = apply {
                    error = failure.error
                    additionalProperties = failure.additionalProperties.toMutableMap()
                }
                ...
                /**
                 * Returns an immutable instance of [Failure].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                 ...
                 */
                fun build(): Failure =
                    Failure(checkRequired("error", error), additionalProperties.toMutableMap())
            }

            private var validated: Boolean = false

            fun validate(): Failure = apply {
                if (validated) {
                    return@apply
                }
            ...
            override fun toString() =
                "Failure{error=$error, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "Data{id=$id, domainId=$domainId, domainName=$domainName, enqueuedAt=$enqueuedAt, failure=$failure, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailFailedEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "EmailFailedEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
