...
class MessageAgentTriggeredEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageAgentTriggeredEvent].
         *
    ...
    /** A builder for [MessageAgentTriggeredEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageAgentTriggeredEvent: MessageAgentTriggeredEvent) = apply {
            id = messageAgentTriggeredEvent.id
            createdAt = messageAgentTriggeredEvent.createdAt
            data = messageAgentTriggeredEvent.data
            type = messageAgentTriggeredEvent.type
            additionalProperties = messageAgentTriggeredEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageAgentTriggeredEvent].
         *
         ...
         */
        fun build(): MessageAgentTriggeredEvent =
    ...
    fun validate(): MessageAgentTriggeredEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageAgentTriggeredEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "MessageAgentTriggeredEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
