...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): EventListParams =
            EventListParams(cursor, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "EventListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
