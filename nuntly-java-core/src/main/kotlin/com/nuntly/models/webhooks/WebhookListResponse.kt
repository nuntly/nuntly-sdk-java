...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookListResponse: WebhookListResponse) = apply {
            ...
            kind = webhookListResponse.kind
            orgId = webhookListResponse.orgId
            region = webhookListResponse.region
            status = webhookListResponse.status
            modifiedAt = webhookListResponse.modifiedAt
    ...
    override fun toString() =
        "WebhookListResponse{id=$id, createdAt=$createdAt, endpointUrl=$endpointUrl, events=$events, kind=$kind, orgId=$orgId, region=$region, status=$status, modifiedAt=$modifiedAt, name=$name, additionalProperties=$additionalProperties}"
}
