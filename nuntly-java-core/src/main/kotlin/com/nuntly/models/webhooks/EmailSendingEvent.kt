...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailSendingEvent].
         *
    ...
    /** A builder for [EmailSendingEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailSendingEvent: EmailSendingEvent) = apply {
            id = emailSendingEvent.id
            createdAt = emailSendingEvent.createdAt
            data = emailSendingEvent.data
            type = emailSendingEvent.type
            additionalProperties = emailSendingEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailSendingEvent].
         *
    ...
    fun validate(): EmailSendingEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @JsonProperty("sending") @ExcludeMissing sending: JsonValue = JsonMissing.of(),
         ...
         * ```java
         * MyClass myObject = data.sending().convert(MyClass.class);
         * ```
         */
        @JsonProperty("sending") @ExcludeMissing fun _sending(): JsonValue = sending
        ...
        class Builder internal constructor() {
            ...
            private var sending: JsonValue? = null
            ...
            fun sending(sending: JsonValue) = apply { this.sending = sending }
        ...
        override fun toString() =
            "Data{id=$id, domainId=$domainId, domainName=$domainName, enqueuedAt=$enqueuedAt, from=$from, messageId=$messageId, orgId=$orgId, sending=$sending, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailSendingEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "EmailSendingEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
