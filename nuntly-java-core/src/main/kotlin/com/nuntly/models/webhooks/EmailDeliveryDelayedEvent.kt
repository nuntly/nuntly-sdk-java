...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailDeliveryDelayedEvent: EmailDeliveryDelayedEvent) = apply {
            ...
            kind = emailDeliveryDelayedEvent.kind
    ...
    private constructor(
        ...
        private val deliveryDelay: JsonField<DeliveryDelayDetail>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            deliveryDelay: JsonField<DeliveryDelayDetail> = JsonMissing.of(),
        ) : this(
            id,
            domain,
            domainId,
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun deliveryDelay(): DeliveryDelayDetail = deliveryDelay.getRequired("delivery_delay")
        ...
        @JsonProperty("delivery_delay")
        @ExcludeMissing
        fun _deliveryDelay(): JsonField<DeliveryDelayDetail> = deliveryDelay
        ...
        class Builder internal constructor() {
            ...
            private var deliveryDelay: JsonField<DeliveryDelayDetail>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            fun deliveryDelay(deliveryDelay: DeliveryDelayDetail) =
                deliveryDelay(JsonField.of(deliveryDelay))

            /**
             * Sets [Builder.deliveryDelay] to an arbitrary JSON value.
             *
             * You should usually call [Builder.deliveryDelay] with a well-typed
             * [DeliveryDelayDetail] value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            fun deliveryDelay(deliveryDelay: JsonField<DeliveryDelayDetail>) = apply {
        ...
        override fun toString() =
            "Data{id=$id, domain=$domain, domainId=$domainId, enqueueAt=$enqueueAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, deliveryDelay=$deliveryDelay, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EmailDeliveryDelayedEvent{id=$id, createdAt=$createdAt, type=$type, kind=$kind, data=$data, additionalProperties=$additionalProperties}"
}
