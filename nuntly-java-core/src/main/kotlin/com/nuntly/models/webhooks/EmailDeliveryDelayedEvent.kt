...
class EmailDeliveryDelayedEvent
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailDeliveryDelayedEvent].
         *
    ...
    /** A builder for [EmailDeliveryDelayedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailDeliveryDelayedEvent: EmailDeliveryDelayedEvent) = apply {
            id = emailDeliveryDelayedEvent.id
            createdAt = emailDeliveryDelayedEvent.createdAt
            data = emailDeliveryDelayedEvent.data
            type = emailDeliveryDelayedEvent.type
            additionalProperties = emailDeliveryDelayedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailDeliveryDelayedEvent].
         *
         ...
         */
        fun build(): EmailDeliveryDelayedEvent =
     ...
     *   expected type.
     */
    fun validate(): EmailDeliveryDelayedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        private val id: JsonField<String>,
        private val deliveryDelay: JsonField<DeliveryDelay>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            deliveryDelay: JsonField<DeliveryDelay> = JsonMissing.of(),
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun deliveryDelay(): DeliveryDelay = deliveryDelay.getRequired("deliveryDelay")
        ...
        /**
         * Returns the raw JSON value of [deliveryDelay].
         *
         * Unlike [deliveryDelay], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("deliveryDelay")
        @ExcludeMissing
        fun _deliveryDelay(): JsonField<DeliveryDelay> = deliveryDelay
        ...
        class Builder internal constructor() {
            ...
            private var id: JsonField<String>? = null
            private var deliveryDelay: JsonField<DeliveryDelay>? = null
            ...
            fun deliveryDelay(deliveryDelay: DeliveryDelay) =
                deliveryDelay(JsonField.of(deliveryDelay))

            /**
             * Sets [Builder.deliveryDelay] to an arbitrary JSON value.
             *
             * You should usually call [Builder.deliveryDelay] with a well-typed [DeliveryDelay]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun deliveryDelay(deliveryDelay: JsonField<DeliveryDelay>) = apply {
            ...
            fun build(): Data =
                Data(
                    checkRequired("id", id),
                    checkRequired("deliveryDelay", deliveryDelay),
        ...
        internal fun validity(): Int =
            (if (id.asKnown().isPresent) 1 else 0) +
                (deliveryDelay.asKnown().getOrNull()?.validity() ?: 0) +
        ...
        private constructor(
            ...
            private val delayType: JsonField<DelayType>,
            ...
            @JsonCreator
            private constructor(
                @JsonProperty("delayedAt")
                @ExcludeMissing
                delayedAt: JsonField<String> = JsonMissing.of(),
                @JsonProperty("delayedRecipients")
                @ExcludeMissing
                delayedRecipients: JsonField<List<DelayedRecipient>> = JsonMissing.of(),
                @JsonProperty("delayType")
                @ExcludeMissing
                delayType: JsonField<DelayType> = JsonMissing.of(),
                @JsonProperty("deliveryStoppedAt")
                @ExcludeMissing
             ...
             *   value).
             */
            fun delayedAt(): String = delayedAt.getRequired("delayedAt")
            ...
            fun delayedRecipients(): List<DelayedRecipient> =
                delayedRecipients.getRequired("delayedRecipients")
             ...
             *   value).
             */
            fun delayType(): DelayType = delayType.getRequired("delayType")
             ...
             *   value).
             */
            fun deliveryStoppedAt(): String = deliveryStoppedAt.getRequired("deliveryStoppedAt")
             ...
             *   value).
             */
            fun reportingMta(): String = reportingMta.getRequired("reportingMta")

            /**
             * Returns the raw JSON value of [delayedAt].
             *
             * Unlike [delayedAt], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("delayedAt")
            @ExcludeMissing
            fun _delayedAt(): JsonField<String> = delayedAt

            /**
             * Returns the raw JSON value of [delayedRecipients].
             *
             * Unlike [delayedRecipients], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("delayedRecipients")
            @ExcludeMissing
             ...
             *
             * Unlike [delayType], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("delayType")
            @ExcludeMissing
            fun _delayType(): JsonField<DelayType> = delayType

            /**
             * Returns the raw JSON value of [deliveryStoppedAt].
             *
             * Unlike [deliveryStoppedAt], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("deliveryStoppedAt")
            @ExcludeMissing
             ...
             *
             * Unlike [reportingMta], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("reportingMta")
            @ExcludeMissing
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [DeliveryDelay].
                 *
                 * The following fields are required:
                 * ```java
                 * .delayedAt()
            ...
            /** A builder for [DeliveryDelay]. */
            class Builder internal constructor() {

                private var delayedAt: JsonField<String>? = null
                private var delayedRecipients: JsonField<MutableList<DelayedRecipient>>? = null
                private var delayType: JsonField<DelayType>? = null
                private var deliveryStoppedAt: JsonField<String>? = null
                private var reportingMta: JsonField<String>? = null
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                @JvmSynthetic
                internal fun from(deliveryDelay: DeliveryDelay) = apply {
                    delayedAt = deliveryDelay.delayedAt
                    delayedRecipients = deliveryDelay.delayedRecipients.map { it.toMutableList() }
                    delayType = deliveryDelay.delayType
                    deliveryStoppedAt = deliveryDelay.deliveryStoppedAt
                    reportingMta = deliveryDelay.reportingMta
                    additionalProperties = deliveryDelay.additionalProperties.toMutableMap()
                }
                 ...
                 *
                 * You should usually call [Builder.delayedAt] with a well-typed [String] value
                 ...
                 * `List<DelayedRecipient>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                fun delayedRecipients(delayedRecipients: JsonField<List<DelayedRecipient>>) =
                    apply {
                ...
                fun delayType(delayType: DelayType) = delayType(JsonField.of(delayType))

                /**
                 * Sets [Builder.delayType] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.delayType] with a well-typed [DelayType] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun delayType(delayType: JsonField<DelayType>) = apply {
                 ...
                 *
                 * You should usually call [Builder.deliveryStoppedAt] with a well-typed [String]
                 ...
                 *
                 * You should usually call [Builder.reportingMta] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                ...
                /**
                 * Returns an immutable instance of [DeliveryDelay].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                 ...
                 * @throws IllegalStateException if any required field is unset.
                 */
                fun build(): DeliveryDelay =
                    DeliveryDelay(
                        checkRequired("delayedAt", delayedAt),
                        checkRequired("delayedRecipients", delayedRecipients).map {
                            it.toImmutable()
                        },
             ...
             *   expected type.
             */
            fun validate(): DeliveryDelay = apply {
                if (validated) {
                    return@apply
                }
            ...
            internal fun validity(): Int =
                (if (delayedAt.asKnown().isPresent) 1 else 0) +
                    (delayedRecipients.asKnown().getOrNull()?.sumOf { it.validity().toInt() }
                        ?: 0) +
                    (delayType.asKnown().getOrNull()?.validity() ?: 0) +
            ...
            private constructor(
                 ...
                 */
                fun diagnosticCode(): Optional<String> =
                    diagnosticCode.getOptional("diagnosticCode")
                 ...
                 *
                 * Unlike [diagnosticCode], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("diagnosticCode")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.diagnosticCode] with a well-typed [String]
                 ...
                 * fields.
                 *
                 * @throws NuntlyInvalidDataException if any value type in this object doesn't match
                 *   its expected type.
                 */
            ...
            class DelayType @JsonCreator private constructor(private val value: JsonField<String>) :
                Enum {
                ...
                companion object {
                    ...
                    @JvmField val INTERNAL_FAILURE = of("InternalFailure")

                    @JvmField val GENERAL = of("General")

                    @JvmField val MAILBOX_FULL = of("MailboxFull")

                    @JvmField val SPAM_DETECTED = of("SpamDetected")

                    @JvmField val RECIPIENT_SERVER_ERROR = of("RecipientServerError")

                    @JvmField val IP_FAILURE = of("IPFailure")

                    @JvmField
                    val TRANSIENT_COMMUNICATION_FAILURE = of("TransientCommunicationFailure")

                    @JvmField
                    val BYOIP_HOST_NAME_LOOKUP_UNAVAILABLE = of("BYOIPHostNameLookupUnavailable")

                    @JvmField val UNDETERMINED = of("Undetermined")

                    @JvmField val SENDING_DEFERRAL = of("SendingDeferral")

                    @JvmStatic fun of(value: String) = DelayType(JsonField.of(value))
                }

                /** An enum containing [DelayType]'s known values. */
                enum class Known {
                    INTERNAL_FAILURE,
                    GENERAL,
                    MAILBOX_FULL,
                ...
                /**
                 * An enum containing [DelayType]'s known values, as well as an [_UNKNOWN] member.
                 *
                 * An instance of [DelayType] can contain an unknown value in a couple of cases:
                ...
                enum class Value {
                    ...
                    SENDING_DEFERRAL,
                    /**
                     * An enum member indicating that [DelayType] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }
                ...
                fun value(): Value =
                    when (this) {
                        ...
                        RECIPIENT_SERVER_ERROR -> Value.RECIPIENT_SERVER_ERROR
                        IP_FAILURE -> Value.IP_FAILURE
                        TRANSIENT_COMMUNICATION_FAILURE -> Value.TRANSIENT_COMMUNICATION_FAILURE
                        BYOIP_HOST_NAME_LOOKUP_UNAVAILABLE ->
                            Value.BYOIP_HOST_NAME_LOOKUP_UNAVAILABLE
                        UNDETERMINED -> Value.UNDETERMINED
                        SENDING_DEFERRAL -> Value.SENDING_DEFERRAL
                        else -> Value._UNKNOWN
                    }
                ...
                fun known(): Known =
                    when (this) {
                        INTERNAL_FAILURE -> Known.INTERNAL_FAILURE
                        GENERAL -> Known.GENERAL
                        MAILBOX_FULL -> Known.MAILBOX_FULL
                        SPAM_DETECTED -> Known.SPAM_DETECTED
                        RECIPIENT_SERVER_ERROR -> Known.RECIPIENT_SERVER_ERROR
                        IP_FAILURE -> Known.IP_FAILURE
                        TRANSIENT_COMMUNICATION_FAILURE -> Known.TRANSIENT_COMMUNICATION_FAILURE
                        BYOIP_HOST_NAME_LOOKUP_UNAVAILABLE ->
                            Known.BYOIP_HOST_NAME_LOOKUP_UNAVAILABLE
                        UNDETERMINED -> Known.UNDETERMINED
                        SENDING_DEFERRAL -> Known.SENDING_DEFERRAL
                        else -> throw NuntlyInvalidDataException("Unknown DelayType: $value")
                    }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is DelayType && value == other.value
                }
            ...
            override fun toString() =
                "DeliveryDelay{delayedAt=$delayedAt, delayedRecipients=$delayedRecipients, delayType=$delayType, deliveryStoppedAt=$deliveryStoppedAt, reportingMta=$reportingMta, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "Data{id=$id, deliveryDelay=$deliveryDelay, domainId=$domainId, domainName=$domainName, enqueuedAt=$enqueuedAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailDeliveryDelayedEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "EmailDeliveryDelayedEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
