...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(emailComplainedEvent: EmailComplainedEvent) = apply {
            ...
            kind = emailComplainedEvent.kind
    ...
    private constructor(
        ...
        private val complaint: JsonField<ComplaintDetail>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            complaint: JsonField<ComplaintDetail> = JsonMissing.of(),
        ) : this(
            id,
            domain,
            domainId,
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun complaint(): ComplaintDetail = complaint.getRequired("complaint")
        ...
        @JsonProperty("complaint")
        @ExcludeMissing
        fun _complaint(): JsonField<ComplaintDetail> = complaint
        ...
        class Builder internal constructor() {
            ...
            private var complaint: JsonField<ComplaintDetail>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            fun complaint(complaint: ComplaintDetail) = complaint(JsonField.of(complaint))

            /**
             * Sets [Builder.complaint] to an arbitrary JSON value.
             *
             * You should usually call [Builder.complaint] with a well-typed [ComplaintDetail] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun complaint(complaint: JsonField<ComplaintDetail>) = apply {
        ...
        override fun toString() =
            "Data{id=$id, domain=$domain, domainId=$domainId, enqueueAt=$enqueueAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, complaint=$complaint, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EmailComplainedEvent{id=$id, createdAt=$createdAt, type=$type, kind=$kind, data=$data, additionalProperties=$additionalProperties}"
}
