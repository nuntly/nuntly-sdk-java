...
private constructor(
    ...
    private constructor(
        ...
        private val delivery: JsonField<DeliveryDetail>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            delivery: JsonField<DeliveryDetail> = JsonMissing.of(),
        ) : this(
            id,
            domain,
            domainId,
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun delivery(): DeliveryDetail = delivery.getRequired("delivery")
        ...
        @JsonProperty("delivery")
        @ExcludeMissing
        fun _delivery(): JsonField<DeliveryDetail> = delivery
        ...
        class Builder internal constructor() {
            ...
            private var delivery: JsonField<DeliveryDetail>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
            ...
            fun delivery(delivery: DeliveryDetail) = delivery(JsonField.of(delivery))

            /**
             * Sets [Builder.delivery] to an arbitrary JSON value.
             *
             * You should usually call [Builder.delivery] with a well-typed [DeliveryDetail] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun delivery(delivery: JsonField<DeliveryDetail>) = apply { this.delivery = delivery }
        ...
        override fun toString() =
            "Data{id=$id, domain=$domain, domainId=$domainId, enqueueAt=$enqueueAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, delivery=$delivery, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "EmailDeliveredEvent{id=$id, createdAt=$createdAt, type=$type, kind=$kind, data=$data, additionalProperties=$additionalProperties}"
}
