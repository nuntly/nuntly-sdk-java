...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailDeliveredEvent].
         *
    ...
    /** A builder for [EmailDeliveredEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailDeliveredEvent: EmailDeliveredEvent) = apply {
            id = emailDeliveredEvent.id
            createdAt = emailDeliveredEvent.createdAt
            data = emailDeliveredEvent.data
            type = emailDeliveredEvent.type
            additionalProperties = emailDeliveredEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailDeliveredEvent].
         *
    ...
    fun validate(): EmailDeliveredEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            delivery: JsonField<Delivery> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.delivery] with a well-typed [Delivery] value
        ...
        private constructor(
             ...
             *   value).
             */
            fun remoteMtaIp(): String = remoteMtaIp.getRequired("remoteMtaIp")
             ...
             *   value).
             */
            fun smtpResponse(): String = smtpResponse.getRequired("smtpResponse")
             ...
             *
             * Unlike [recipients], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("recipients")
            @ExcludeMissing
             ...
             *
             * Unlike [remoteMtaIp], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("remoteMtaIp")
            @ExcludeMissing
             ...
             *
             * Unlike [smtpResponse], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("smtpResponse")
            @ExcludeMissing
             ...
             *
             * Unlike [processingTime], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("processingTime")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(delivery: Delivery) = apply {
                    ...
                    recipients = delivery.recipients.map { it.toMutableList() }
                 ...
                 *
                 * You should usually call [Builder.deliveredAt] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun deliveredAt(deliveredAt: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.recipients] with a well-typed `List<String>`
                 ...
                 *
                 * You should usually call [Builder.remoteMtaIp] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun remoteMtaIp(remoteMtaIp: JsonField<String>) = apply {
                 ...
                 *
                 * You should usually call [Builder.smtpResponse] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                ...
                fun processingTime(processingTime: Double) =
                    processingTime(JsonField.of(processingTime))
            ...
            override fun toString() =
                "Delivery{deliveredAt=$deliveredAt, recipients=$recipients, remoteMtaIp=$remoteMtaIp, reportingMta=$reportingMta, smtpResponse=$smtpResponse, processingTime=$processingTime, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "Data{id=$id, delivery=$delivery, domainId=$domainId, domainName=$domainName, enqueuedAt=$enqueuedAt, from=$from, messageId=$messageId, orgId=$orgId, sentAt=$sentAt, subject=$subject, to=$to, bcc=$bcc, bulkId=$bulkId, cc=$cc, headers=$headers, replyTo=$replyTo, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailDeliveredEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "EmailDeliveredEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
