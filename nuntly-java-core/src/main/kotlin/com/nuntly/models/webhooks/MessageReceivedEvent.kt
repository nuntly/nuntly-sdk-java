...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MessageReceivedEvent].
         *
    ...
    /** A builder for [MessageReceivedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(messageReceivedEvent: MessageReceivedEvent) = apply {
            id = messageReceivedEvent.id
            createdAt = messageReceivedEvent.createdAt
            data = messageReceivedEvent.data
            type = messageReceivedEvent.type
            additionalProperties = messageReceivedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MessageReceivedEvent].
         *
         ...
         */
        fun build(): MessageReceivedEvent =
    ...
    fun validate(): MessageReceivedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MessageReceivedEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "MessageReceivedEvent{id=$id, createdAt=$createdAt, data=$data, type=$type, additionalProperties=$additionalProperties}"
}
