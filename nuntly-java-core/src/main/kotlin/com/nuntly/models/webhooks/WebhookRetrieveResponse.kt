...
private constructor(
    ...
    override fun toString() =
        "WebhookRetrieveResponse{id=$id, createdAt=$createdAt, endpointUrl=$endpointUrl, events=$events, status=$status, name=$name, additionalProperties=$additionalProperties}"
}
