...
package com.nuntly.api.models.organizations.subscriptions
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): SubscriptionListParams =
            SubscriptionListParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "SubscriptionListParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
