...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): ApiKeyRetrieveParams =
            ApiKeyRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "ApiKeyRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
