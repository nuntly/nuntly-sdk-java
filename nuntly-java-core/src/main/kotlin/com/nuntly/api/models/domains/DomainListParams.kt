...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DomainListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DomainListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DomainListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(domainListParams: DomainListParams) = apply {
            cursor = domainListParams.cursor
            limit = domainListParams.limit
            additionalHeaders = domainListParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [DomainListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DomainListParams =
            DomainListParams(
                cursor,
                limit,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DomainListParams &&
            cursor == other.cursor &&
            limit == other.limit &&
    ...
    override fun toString() =
        "DomainListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
