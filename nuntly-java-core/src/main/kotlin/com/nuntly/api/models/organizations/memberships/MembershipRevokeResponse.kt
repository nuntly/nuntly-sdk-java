...
private constructor(
    ...
    ) : this(kind, orgId, userId, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MembershipRevokeResponse].
         *
    ...
    /** A builder for [MembershipRevokeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(membershipRevokeResponse: MembershipRevokeResponse) = apply {
            kind = membershipRevokeResponse.kind
            orgId = membershipRevokeResponse.orgId
            userId = membershipRevokeResponse.userId
            additionalProperties = membershipRevokeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [MembershipRevokeResponse].
         *
         ...
         */
        fun build(): MembershipRevokeResponse =
    ...
    fun validate(): MembershipRevokeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MembershipRevokeResponse &&
            kind == other.kind &&
            orgId == other.orgId &&
            userId == other.userId &&
    ...
    private val hashCode: Int by lazy { Objects.hash(kind, orgId, userId, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "MembershipRevokeResponse{kind=$kind, orgId=$orgId, userId=$userId, additionalProperties=$additionalProperties}"
}
