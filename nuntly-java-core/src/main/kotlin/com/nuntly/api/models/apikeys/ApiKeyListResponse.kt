...
private constructor(
    ...
    private val apikeyTruncated: JsonField<String>,
    ...
    private constructor(
        ...
        @JsonProperty("apikey_truncated")
        @ExcludeMissing
        apikeyTruncated: JsonField<String> = JsonMissing.of(),
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun apikeyTruncated(): String = apikeyTruncated.getRequired("apikey_truncated")
    ...
    /**
     * Returns the raw JSON value of [apikeyTruncated].
     *
     * Unlike [apikeyTruncated], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("apikey_truncated")
    @ExcludeMissing
    fun _apikeyTruncated(): JsonField<String> = apikeyTruncated
    ...
    class Builder internal constructor() {
        ...
        private var apikeyTruncated: JsonField<String>? = null
        ...
        internal fun from(apiKeyListResponse: ApiKeyListResponse) = apply {
            id = apiKeyListResponse.id
            apikeyTruncated = apiKeyListResponse.apikeyTruncated
            createdAt = apiKeyListResponse.createdAt
            kind = apiKeyListResponse.kind
            orgId = apiKeyListResponse.orgId
            region = apiKeyListResponse.region
            status = apiKeyListResponse.status
            userId = apiKeyListResponse.userId
            modifiedAt = apiKeyListResponse.modifiedAt
            name = apiKeyListResponse.name
        ...
        /** The truncated content of the api key */
        fun apikeyTruncated(apikeyTruncated: String) =
            apikeyTruncated(JsonField.of(apikeyTruncated))

        /**
         * Sets [Builder.apikeyTruncated] to an arbitrary JSON value.
         *
         * You should usually call [Builder.apikeyTruncated] with a well-typed [String] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun apikeyTruncated(apikeyTruncated: JsonField<String>) = apply {
            this.apikeyTruncated = apikeyTruncated
        }
        ...
        fun build(): ApiKeyListResponse =
            ApiKeyListResponse(
                checkRequired("id", id),
                checkRequired("apikeyTruncated", apikeyTruncated),
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            (if (apikeyTruncated.asKnown().isPresent) 1 else 0) +
    ...
    class Kind @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val API_KEY = of("api-key")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ApiKeyListResponse &&
            id == other.id &&
            apikeyTruncated == other.apikeyTruncated &&
    ...
    override fun toString() =
        "ApiKeyListResponse{id=$id, apikeyTruncated=$apikeyTruncated, createdAt=$createdAt, kind=$kind, orgId=$orgId, region=$region, status=$status, userId=$userId, modifiedAt=$modifiedAt, name=$name, additionalProperties=$additionalProperties}"
}
