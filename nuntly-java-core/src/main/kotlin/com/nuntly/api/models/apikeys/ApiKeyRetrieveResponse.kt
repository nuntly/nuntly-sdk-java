...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(apiKeyRetrieveResponse: ApiKeyRetrieveResponse) = apply {
            ...
            apikeyTruncated = apiKeyRetrieveResponse.apikeyTruncated
            createdAt = apiKeyRetrieveResponse.createdAt
            kind = apiKeyRetrieveResponse.kind
            orgId = apiKeyRetrieveResponse.orgId
            region = apiKeyRetrieveResponse.region
            status = apiKeyRetrieveResponse.status
            userId = apiKeyRetrieveResponse.userId
            modifiedAt = apiKeyRetrieveResponse.modifiedAt
    ...
    override fun toString() =
        "ApiKeyRetrieveResponse{id=$id, apikeyTruncated=$apikeyTruncated, createdAt=$createdAt, kind=$kind, orgId=$orgId, region=$region, status=$status, userId=$userId, modifiedAt=$modifiedAt, name=$name, additionalProperties=$additionalProperties}"
}
