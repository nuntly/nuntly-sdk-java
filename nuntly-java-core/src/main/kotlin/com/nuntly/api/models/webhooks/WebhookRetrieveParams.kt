...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): WebhookRetrieveParams =
            WebhookRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "WebhookRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
