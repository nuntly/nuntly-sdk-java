...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [WebhookDeleteResponse].
         *
    ...
    /** A builder for [WebhookDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(webhookDeleteResponse: WebhookDeleteResponse) = apply {
            id = webhookDeleteResponse.id
            kind = webhookDeleteResponse.kind
            orgId = webhookDeleteResponse.orgId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookDeleteResponse &&
            id == other.id &&
            kind == other.kind &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "WebhookDeleteResponse{id=$id, kind=$kind, orgId=$orgId, additionalProperties=$additionalProperties}"
}
