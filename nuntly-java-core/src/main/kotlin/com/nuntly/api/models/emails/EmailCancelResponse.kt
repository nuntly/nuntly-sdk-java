...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EmailCancelResponse].
         *
    ...
    /** A builder for [EmailCancelResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(emailCancelResponse: EmailCancelResponse) = apply {
            id = emailCancelResponse.id
            kind = emailCancelResponse.kind
            orgId = emailCancelResponse.orgId
            additionalProperties = emailCancelResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EmailCancelResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EmailCancelResponse &&
            id == other.id &&
            kind == other.kind &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "EmailCancelResponse{id=$id, kind=$kind, orgId=$orgId, additionalProperties=$additionalProperties}"
}
