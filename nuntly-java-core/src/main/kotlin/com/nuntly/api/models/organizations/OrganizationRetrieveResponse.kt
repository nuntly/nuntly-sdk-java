...
private constructor(
    ...
    ) : this(createdAt, displayName, kind, orgId, region, status, modifiedAt, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationRetrieveResponse].
         *
    ...
    /** A builder for [OrganizationRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(organizationRetrieveResponse: OrganizationRetrieveResponse) = apply {
            createdAt = organizationRetrieveResponse.createdAt
            displayName = organizationRetrieveResponse.displayName
            kind = organizationRetrieveResponse.kind
            orgId = organizationRetrieveResponse.orgId
            region = organizationRetrieveResponse.region
            status = organizationRetrieveResponse.status
            modifiedAt = organizationRetrieveResponse.modifiedAt
            additionalProperties = organizationRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrganizationRetrieveResponse].
         *
         ...
         */
        fun build(): OrganizationRetrieveResponse =
    ...
    fun validate(): OrganizationRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrganizationRetrieveResponse &&
    ...
    override fun toString() =
        "OrganizationRetrieveResponse{createdAt=$createdAt, displayName=$displayName, kind=$kind, orgId=$orgId, region=$region, status=$status, modifiedAt=$modifiedAt, additionalProperties=$additionalProperties}"
}
