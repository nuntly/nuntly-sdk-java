...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DomainCreateParams].
         *
    ...
    /** A builder for [DomainCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(domainCreateParams: DomainCreateParams) = apply {
            body = domainCreateParams.body.toBuilder()
            additionalHeaders = domainCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = domainCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DomainCreateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DomainCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "DomainCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
