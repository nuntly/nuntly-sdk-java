...
import com.nuntly.api.core.http.PhantomReachableClosingHttpClient
import com.nuntly.api.core.http.QueryParams
import com.nuntly.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `nuntly-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [com.nuntly.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("nuntly.baseUrl") ?: System.getenv("NUNTLY_BASE_URL"))?.let {
                baseUrl(it)
            }
                        ...
                        object : ThreadFactory {
                            ...
                            override fun newThread(runnable: Runnable): Thread =
                                threadFactory.newThread(runnable).also {
                                    it.name =
                                        "nuntly-stream-handler-thread-${count.getAndIncrement()}"
                                }
                        }
                    ),
                clock,
