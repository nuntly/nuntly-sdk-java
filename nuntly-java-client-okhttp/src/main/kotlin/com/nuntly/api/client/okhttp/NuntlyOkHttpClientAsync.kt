...
/**
 * A class that allows building an instance of [NuntlyClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class NuntlyOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [NuntlyClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): NuntlyClientAsync = builder().fromEnv().build()
    }

    /** A builder for [NuntlyOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.nuntly.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [NuntlyClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NuntlyClientAsync =
            NuntlyClientAsyncImpl(
                clientOptions
                    .httpClient(
