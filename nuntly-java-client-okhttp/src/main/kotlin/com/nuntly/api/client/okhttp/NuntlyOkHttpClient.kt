...
import com.nuntly.api.client.NuntlyClientImpl
...
/**
 * A class that allows building an instance of [NuntlyClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class NuntlyOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [NuntlyClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): NuntlyClient = builder().fromEnv().build()
    }

    /** A builder for [NuntlyOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [NuntlyClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NuntlyClient =
            NuntlyClientImpl(
                clientOptions
                    .httpClient(
