...
import com.nuntly.api.core.http.HttpRequestBody
import com.nuntly.api.core.http.HttpResponse
import com.nuntly.api.errors.NuntlyIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
            ...
            .enqueue(
                object : Callback {
                    ...
                    override fun onFailure(call: Call, e: IOException) {
                        future.completeExceptionally(NuntlyIoException("Request failed", e))
                    }
                }
            )
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("NUNTLY_LOG")?.lowercase()) {
