...
dependencies {
    testImplementation(project(":nuntly-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../nuntly-java-core/src/main/resources/META-INF/proguard/nuntly-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.nuntly.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../nuntly-java-core/src/main/resources/META-INF/proguard/nuntly-java-core.pro",
